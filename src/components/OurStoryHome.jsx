    ...
    <section className="section-wash py-8 sm:py-16">
      ...
      >
        <div className="home-story-outline">
          ...
          <h2 className="heading-brand mb-4 font-serif text-2xl font-semibold sm:mb-6 sm:text-4xl">
            About The Paper Story
          </h2>
          <p className="mb-5 text-sm leading-relaxed text-paperstory-ink/75 sm:mb-8 sm:text-lg">
