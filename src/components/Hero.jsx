...
export default function Hero() {
  return (
    <section id="home" className="cute-hero relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-4 pt-32 pb-20 sm:px-6 lg:flex-row lg:items-center lg:gap-12 lg:px-8 lg:pb-24">
        <div className="flex flex-1 flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <p className="mb-6 max-w-md font-serif text-xl leading-relaxed text-paperstory-ink/90 italic sm:text-2xl">
            More than paper. Designed to hold emotions.
          </p>

          <div className="flex w-full justify-center lg:justify-start">
            <div className="inline-flex w-full max-w-lg flex-col items-center gap-3">
              <div className="inline-flex items-center gap-2 rounded-full bg-paperstory-maroon px-5 py-2 text-xs font-semibold tracking-widest text-paperstory-cream uppercase shadow-sm">
                Orders are open <span>✦</span>
              </div>

              <div className="flex w-full flex-col gap-3 sm:flex-row sm:justify-center">
                <Link to="/shop" className="cute-btn-primary">VIEW COLLECTION</Link>
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="cute-btn-primary">
