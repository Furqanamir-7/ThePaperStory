    ...
    <section id="home" className="cute-hero relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-4 pt-32 pb-20 sm:px-6 lg:flex-row lg:items-center lg:gap-12 lg:px-8 lg:pb-24">
        <div className="flex flex-1 flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <div className="mb-8 inline-flex items-center gap-2 rounded-full bg-paperstory-maroon px-5 py-2 text-xs font-semibold tracking-widest text-paperstory-cream uppercase shadow-sm">
          ...
          <div className="flex w-full max-w-sm flex-col gap-3 sm:max-w-none sm:flex-row sm:justify-center lg:justify-start">
            <Link to="/shop" className="cute-btn-primary">Browse the Shop</Link>
